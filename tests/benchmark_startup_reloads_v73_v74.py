...
def main():
 ...
 try: results=[run_version('v7.3.0',V73,'7.3.0',port,browser),run_version('v7.4.0',V74,'7.4.0',port,browser)]
 ...
 target=ROOT/'dist/UltraDeck-v7.4.0-startup-reload-ab.json';target.write_text(json.dumps(out,indent=2)+'\n');print(json.dumps(out,indent=2))
