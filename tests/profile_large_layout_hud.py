...
with sync_playwright() as pw:
 ...
 p.evaluate("()=>document.querySelector('#tu-ultrawide-deck-ui').shadowRoot.querySelector('[data-col=\"8\"]').click()");p.wait_for_function("window.__TumblrUltraWideDeck.diagnostics().renderedColumns===8",timeout=10000);p.wait_for_timeout(100)
 ...
 elapsed=p.evaluate("()=>{const b=document.querySelector('#tu-ultrawide-deck-ui').shadowRoot.querySelector('[data-col=\"20\"]');const t=performance.now();b.click();return performance.now()-t}")
