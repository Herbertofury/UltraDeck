...
def main():
 ...
 try: rows=[run('v7.2.0',V72,'7.2.0',port,browser),run('v7.3.0',V73,'7.3.0',port,browser)]
 ...
 target=ROOT/'dist/UltraDeck-v7.3.0-layout-hotpath-ab.json';target.parent.mkdir(exist_ok=True);target.write_text(json.dumps(out,indent=2)+'\n');print(json.dumps(out,indent=2))
