export function startUltraDeck() {
  if (globalThis.__UltraDeckExtensionRuntimeVersion === '8.2.0') return;
  if (!globalThis.__UltraDeckSiteAdapter) return;
  Object.defineProperty(globalThis, '__UltraDeckExtensionRuntimeVersion', { configurable:true, value:'8.2.0' });
    'use strict';
